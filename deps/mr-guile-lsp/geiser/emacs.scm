...
(define-module (mr-guile-lsp geiser emacs)
  #:use-module (ice-9 match)
  #:use-module (system repl command)
  #:use-module (system repl error-handling)
  #:use-module (system repl server)
  #:use-module (mr-guile-lsp geiser evaluation)
  #:use-module ((mr-guile-lsp geiser modules) #:renamer (symbol-prefix-proc 'ge:))
  #:use-module ((mr-guile-lsp geiser completion) #:renamer (symbol-prefix-proc 'ge:))
  #:use-module ((mr-guile-lsp geiser xref) #:renamer (symbol-prefix-proc 'ge:))
  #:use-module ((mr-guile-lsp geiser doc) #:renamer (symbol-prefix-proc 'ge:)))
